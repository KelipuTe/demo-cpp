...
void testParserDoParse() {
    ParserTestCase *tcList[] = {
            ...
            //new ParserTestCase("IF_HKNI", "if(a==2){b=10;}else{b=20;}", INPUT_MODE),
            //new ParserTestCase("IF_HKNI", "if(a==2 && c==2){b=10;}", INPUT_MODE),
            //new ParserTestCase("FOR_HKNI", "for(i=1;i<10;++i){j+=2;}", INPUT_MODE),
